...
const RouletteWheelSection = ({ participants, getWinner }) => {
    ...
    return (
        <>
                    ...
                    <div className="relative w-[600px] h-[600px]">
                        ...
                        >
                            ...
                            {eligibleParticipants.map((p, i) => {
                                ...
                                const textX =
                                    300 + textRadius * Math.cos(midAngleRad);
                                const textY =
                                    300 + textRadius * Math.sin(midAngleRad);
                                const textRotation = midAngle + 360;
            ...
            {showModal && winner && (
                <div className="fixed inset-0 z-30 flex items-center justify-center bg-black bg-opacity-90 winner-modal-fade">
...
export default RouletteWheelSection;
