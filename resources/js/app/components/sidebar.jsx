...
import { setIsMobile, setOpenMobile, setState } from '../redux/app-slice';
...
function Sidebar({
    ...
    const { openMobile, isMobile, state } = useSelector((store) => store.app);
    const dispatch = useDispatch();
    ...
    if (isMobile) {
        return (
            <Sheet
                open={openMobile}
                onOpenChange={() => dispatch(setOpenMobile())}
                {...props}
            >
...
function SidebarMenuButton({
    ...
    const Comp = asChild ? Slot : 'button';
    const { isMobile, state } = useSelector((store) => store.app);
