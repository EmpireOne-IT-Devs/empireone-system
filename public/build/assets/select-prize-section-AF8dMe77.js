import{u as d,j as e}from"./app-CjJEGrvZ.js";function u({selectedPrize:t,setSelectedPrize:n,prizeWinners:o}){const{prizes:c}=d(s=>s.raffles);return e.jsxs("div",{className:"space-y-4 p-4",children:[e.jsx("style",{children:`
                @keyframes pulse {
                    0%, 100% {
                        transform: scale(1);
